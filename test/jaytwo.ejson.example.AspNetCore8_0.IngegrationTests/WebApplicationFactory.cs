...
namespace jaytwo.ejson.example.AspNetCore8_0.IngegrationTests
{
    public class WebApplicationFactory
        : WebApplicationFactory<example.AspNetCore8_0.Startup>
    {
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            var contentRoot = new SlnFileResolver().ResolvePathRelativeToSln("examples/jaytwo.ejson.example.AspNetCore8_0");
