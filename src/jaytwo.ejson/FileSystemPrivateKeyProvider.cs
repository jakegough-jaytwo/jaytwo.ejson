...
namespace jaytwo.ejson
{
    public class FileSystemPrivateKeyProvider : IPrivateKeyProvider
    {
        ...
        public string SavePrivateKey(string publicKey, string privateKey)
        {
            ...
            {
                throw new InvalidOperationException("Could not determine key directory");
            }
        ...
        internal IList<string> GetPrioritizedKeyDirs()
        {
            ...
            else
            {
                var keyDirs = new[]
                {
                    ...
                    new { keyDir = (string?)DefaultUnixKeyDir, platform = "unix" },
                };
                ...
                return keyDirs
                    .Where(x => !string.IsNullOrWhiteSpace(x.keyDir))
                    .OrderByDescending(x => x.platform == "unix")
                    .ThenByDescending(x => x.platform == "windows")
                    .Select(x => x.keyDir!)
                    .ToList();
#endif
            }
